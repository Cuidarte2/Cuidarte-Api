...
namespace Infraestructura.Persistence.Migrations
{
    ...
    [Migration("20260922171353_ajustesServicioYClienteConfig")]
    partial class ajustesServicioYClienteConfig
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LogicaNegocio.Entidades.Servicio", b =>
                {
                    ...
                    b.Property<int?>("ClienteDisponibleId")
                        .HasColumnType("integer");

                    b.Property<int?>("ClienteExtraId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ClienteDisponibleId");

                    b.HasIndex("ClienteExtraId");
